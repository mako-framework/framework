...
<div id="mako-debug">
	...
	<div class="mako-panel" id="mako-queries">
		<div class="mako-close"><a onclick="Mako.toggleDisplay('mako-queries')">close</a></div>
	...
	<div class="mako-panel" id="mako-log">
		<div class="mako-close"><a onclick="Mako.toggleDisplay('mako-log')">close</a></div>
		<?php if(empty($logs)): ?>
	...
	<div class="mako-panel" id="mako-variables">
		<div class="mako-close"><a onclick="Mako.toggleDisplay('mako-variables')">close</a></div>
	...
	<div class="mako-panel" id="mako-files">
		<div class="mako-close"><a onclick="Mako.toggleDisplay('mako-files')">close</a></div>
	...
	<div class="mako-toolbar">
		...
		<a class="mako-button" onclick="Mako.toggleDisplay('mako-queries')"><span class="mako-strong"><?php echo count($queries); ?></span> database queries<?php if(count($queries) != 0): ?> <span class="mako-small">( <?php echo $db_time; ?> seconds )</span><?php endif; ?></a>
		<a class="mako-button" onclick="Mako.toggleDisplay('mako-log')"><span class="mako-strong"><?php echo count($logs); ?></span> log entries</a>
		<a class="mako-button" onclick="Mako.toggleDisplay('mako-files')"><span class="mako-strong"><?php echo count($files); ?></span> included files</a>
		<a class="mako-button" onclick="Mako.toggleDisplay('mako-variables')">superglobals</a>
	</div>
