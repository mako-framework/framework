...
namespace mako\cache
{
	...
	*/
	...
	class SQLite extends \mako\cache\Core
	{
		//---------------------------------------------
		// Class variables
		//---------------------------------------------
		...
		*/
		...
		public function __construct(array $config)
		{
			...
			{
				throw new CacheException(__CLASS__.': PDO is not available.');
			}
			...
			{
				throw new CacheException(__CLASS__.': Unable to create cache database.<br /><br />' . $e->getMessage());
			}
		}
